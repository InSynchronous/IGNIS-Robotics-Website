...
const leadership = [
  ...
  ['Roger Huynh', 'Technical Lead — Mechanical', 'Roger.png', 'Roger has experience with autonomous robots and Botball, where he developed hands-on skills in robotics and problem-solving. At IGNIS, he applies that experience to mechanical engineering, robot design, and building reliable competition systems.', 'rogerhuynh07@gmail.com'],
]
...
function Home() {
  return <>
    ...
    <section className="section-wrap home-cta"><div><Eyebrow>Make an impact</Eyebrow><h2>There is a place for you on this team.</h2></div><ArrowLink to="/contact" dark>Get in touch</ArrowLink></section>
  </>
}
